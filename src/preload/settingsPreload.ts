...
const settingsApi: SettingsApi = {
  ...
  updateCaptureSourceMode: (mode) => ipcRenderer.invoke(IPC_CHANNELS.updateCaptureSourceMode, mode),
  updateAnswerTriggerMode: (mode) => ipcRenderer.invoke(IPC_CHANNELS.updateAnswerTriggerMode, mode),
