...
- **Identity and Access Management (Microsoft Entra ID)**:
    ...
    | Scenario | BusinessBasic | BusinessStandard | BusinessPremium |
    | --- | --- | --- | --- |
...
- **Data Security and Compliance (Information Protection)**:
    ...
    | Scenario | BusinessBasic | BusinessStandard | BusinessPremium |
    | --- | --- | --- | --- |
    | Search for Copilot generated data and interactions with eDiscovery capabilities. | Search and export results | Search and export results | Search and export results  and  Case management and legal hold |
